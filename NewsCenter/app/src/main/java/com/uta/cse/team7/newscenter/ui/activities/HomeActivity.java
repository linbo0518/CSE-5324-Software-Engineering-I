package com.uta.cse.team7.newscenter.ui.activities;
...
import com.uta.cse.team7.newscenter.models.Categories;
import com.uta.cse.team7.newscenter.models.CategoryItem;
import com.uta.cse.team7.newscenter.models.SettingsPreferences;
import com.uta.cse.team7.newscenter.models.SourceItem;
import com.uta.cse.team7.newscenter.sources.ISourceView;
import com.uta.cse.team7.newscenter.sources.SourcesPresenter;
import com.uta.cse.team7.newscenter.ui.adapters.CategoryListAdapter;
import com.uta.cse.team7.newscenter.ui.fragments.ArchiveFragment;
import com.uta.cse.team7.newscenter.ui.fragments.FeedsFragment;
import com.uta.cse.team7.newscenter.ui.fragments.ManageSourcesFragment;
import com.uta.cse.team7.newscenter.utils.AnimationUtil;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_feeds) {
            if (secondaryLayout.getVisibility() == View.INVISIBLE && mNavPosition != 0) {
                ...
                txtToolbarTitle.setText("Add Feeds");
...
//        }
            ...
            Toast.makeText(getApplicationContext(),"UTA Team 7",Toast.LENGTH_SHORT).show();
            mNavPosition = 4;
        }
    ...
    public void dataSourceSaveFailed(String message) {
        if (message.equals("name_url_category_empty")) {
            message = "Name, URL and Category can not be empty";
            eTxtSourceName.setError("Please input a valid name");
            eTxtSourceUrl.setError("Please input a valid URL");
            ...
            message = "Caetgory can not be empty";
